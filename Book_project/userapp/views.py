...
# from userapp.models import Book, Author
...
def listBook(request):
    books = Book.objects.all().order_by('id')  # Ensure books are ordered
    ...
    try:
        ...
        page = paginator.page(paginator.num_pages)  # Show the last page if out of bounds
        ...
        if request.method == 'POST':
            ...
            for cart_item in cart_items:
                line_item = {
                    ...
                    'quantity': 1 # Fixed: Correct spelling of 'quantity'
                }
                line_items.append(line_item)

            if line_items:  # Indentation fixed
